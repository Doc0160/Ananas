...
define("PERMISSION_MODIFY_ACTIVITY", 2^$i++);
define("PERMISSION_DELETE_ACTIVITY", 2^$i++);

define("PERMISSION_READ_PHOTO", 2^$i++);
define("PERMISSION_MODIFY_PHOTO", 2^$i++);
define("PERMISSION_DELETE_PHOTO", 2^$i++);
